...
# Assess 311 dataset only (individual analysis focuses on 311 data)
...
This code above (incident_zip = str_extract(incident_zip, "\\d{5}")) cleans the zip code to ensure that we obtain 5 digit zip codes instead of missing or invalid values. 
